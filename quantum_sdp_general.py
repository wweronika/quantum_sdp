...
def coefficients_from_expectation_values_1(A, B, AB): # 1 denotes eigenvalues -1, 1
    n_outcomes_A = 2
    n_outcomes_B = 2
    n_measurements_A = len(A)
    n_measurements_B = len(B)
...
def coefficients_from_expectation_values_2(A, B, AB): # 2 denotes eigenvalues 0, 1
    n_outcomes_A = 2
    n_outcomes_B = 2
    n_measurements_A = len(A)
    n_measurements_B = len(B)
